...
curl -L https://github.com/alauda/ovs/commit/df1c802f568be2af84aa81372fec46f5b09b4366.patch | git apply
...
git clone -b branch-20.06-sfc-lb --depth=1 https://github.com/destinysky/ovn.git
cd ovn

...
type ServiceFunctionChainInterface interface {
	...
	UpdateStatus(*v1.ServiceFunctionChain) (*v1.ServiceFunctionChain, error)
...
func newServiceFunctionChains(c *KubeovnV1Client, namespace string) *serviceFunctionChains {
...
func (c *serviceFunctionChains) UpdateStatus(serviceFunctionChain *v1.ServiceFunctionChain) (result *v1.ServiceFunctionChain, err error) {
	result = &v1.ServiceFunctionChain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicefunctionchains").

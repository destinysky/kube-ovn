...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("logicalportpairs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kubeovn().V1().LogicalPortPairs().Informer()}, nil
